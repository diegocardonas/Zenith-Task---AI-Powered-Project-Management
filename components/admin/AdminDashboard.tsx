      ...
      <div className="flex-grow p-3 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <StatCard 
                ...
                icon="list" 
                onClick={() => handleTaskStatCardClick('all', 'Todas las Tareas')} 
            ...
            <StatCard 
                ...
                icon="check" 
                onClick={() => handleTaskStatCardClick('completed', 'Tareas Completadas')}
            ...
            <StatCard 
                ...
                icon="alert" 
                onClick={() => handleTaskStatCardClick('overdue', 'Tareas Atrasadas')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-surface rounded-lg p-6 animate-fadeIn flex flex-col">
            <h2 className="text-xl font-semibold mb-4 flex-shrink-0">Tareas por Estado</h2>
          ...
          <div className="lg:col-span-2 bg-surface rounded-lg p-6 animate-fadeIn flex flex-col" style={{ animationDelay: '100ms' }}>
            <h2 className="text-xl font-semibold mb-4 flex-shrink-0">Tareas por Prioridad</h2>
          ...
          <div className="lg:col-span-3 bg-surface rounded-lg p-6 animate-fadeIn" style={{ animationDelay: '200ms' }}>
            <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                <h2 className="text-xl font-semibold">Carga de Trabajo de Usuario</h2>
